...
public class ProductOptionVO {
    ...
    public String toString() {
        return "ProductOptionVO [pr_id=" + pr_id + ", pr_opt_id=" + pr_opt_id + ", pr_opt_name="
            + pr_opt_name
            + ", pr_opt_stock=" + pr_opt_stock + ", pr_opt_price=" + pr_opt_price
            + ", pr_opt_status="
            + pr_opt_status + ", getPr_opt_status()=" + getPr_opt_status() + ", getPr_id()="
            + getPr_id()
            + ", getPr_opt_id()=" + getPr_opt_id() + ", getPr_opt_name()=" + getPr_opt_name()
            + ", getPr_opt_stock()=" + getPr_opt_stock() + ", getPr_opt_price()="
            + getPr_opt_price()
