...
public class ProductsVO {
    ...
    public String toString() {
        return "ProductsVO [pr_id=" + pr_id + ", pr_name=" + pr_name + ", pr_desc=" + pr_desc
            + ", pr_detail_desc="
            + pr_detail_desc + ", pr_up_date=" + pr_up_date + ", pr_status=" + pr_status
            + ", pr_category="
            + pr_category + ", pr_thumbnail=" + pr_thumbnail + ", pr_thumbnail_file="
            + pr_thumbnail_file
