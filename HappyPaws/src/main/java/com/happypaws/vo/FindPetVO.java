...
public class FindPetVO {
	...
	public String toString() {
		return "FindPetVO [fp_seq=" + fp_seq + ", fp_id=" + fp_id + ", fp_role=" + fp_role + ", fp_code=" + fp_code
				+ ", fp_title=" + fp_title + ", fp_ph=" + fp_ph + ", fp_place=" + fp_place + ", fp_time=" + fp_time
				+ ", fp_category=" + fp_category + ", fp_breed=" + fp_breed + ", fp_content=" + fp_content
				+ ", fp_date=" + fp_date + ", fp_cnt=" + fp_cnt + ", fp_ok=" + fp_ok + ", fp_del=" + fp_del
