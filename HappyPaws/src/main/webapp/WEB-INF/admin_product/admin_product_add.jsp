        ...
        <form action="ad_manageProductAdd" method="POST" enctype="multipart/form-data"
            ...
            <div class="form-group" style="text-align: center">
                <label for="pr_thumbnail_file" style="display: block; cursor: pointer;">
                    <div class="image-upload">
                        ...
                        <img id="image-preview" src="../../resources/images/HappyPawsLogo.png"
            ...
            <div class="form-group">
                <label for="pr_price">대표 가격(원) <input type="number"
                                                      id="pr_price" name="pr_price" value=""
                ...
                <div class="option-group">
                    <div class="option-name_status">
                        <label for="pr_opt_name"></label> <input type="text"
                                                                 name="pr_opt_name" id="pr_opt_name"
                                                                 value=""
                    ...
                    <div class="option-stock_price">
                        <label for="pr_opt_price">
                            <input type="number" id="pr_opt_price" name="pr_opt_price" value=""
                                   placeholder="옵션 추가금 입력" required>
                        </label>
                        <label for="pr_opt_stock">
                            <input type="number" id="pr_opt_stock" name="pr_opt_stock" value=""
                                   placeholder="재고 수량 입력" required>
                        </label>
